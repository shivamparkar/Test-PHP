...
<body class="boxed_wrapper ltr">
    ...
    <!-- working-style-two -->
    <section class="working-style-two service-page-1">
        <div class="auto-container">
            <div class="sec-title style-four right">
                <h5>We make it happen</h5>
                <h2>Follow Working Steps</h2>
                <p>Tempor incididunt ut labore et dolore magna aliquat enim veniam quis nostrud <br />exercitation ullamco laboris nis aliquip consequat duis.</p>
            </div>
            <div class="row clearfix">
                <div class="col-lg-4 col-md-6 col-sm-12 working-block">
                    <div class="working-block-two">
                        <div class="inner-box">
                            <div class="border-box" style="background-image: url(assets/images/icons/border-1.png);"></div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 working-block">
                    <div class="working-block-two">
                        <div class="inner-box">
                            <div class="border-box" style="background-image: url(assets/images/icons/border-2.png);"></div>
                            <div class="icon-box"><i class="flaticon-target"></i></div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-7 col-md-6 col-sm-12 inner-column">
                        <div class="inner-box">
                            ...
                            <form action="http://azim.commonsupport.com/Fionca/contact.html" method="post" class="submit-form">
                                <div class="form-group">
